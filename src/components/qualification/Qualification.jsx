    ...
    const qualificationData = [
        {
            ...
            educationDetail: [
                {
                    educationName: 'Al-Shams Public School',
                    educationLocation: 'Karachi - School',
                    educationDuration: '2011 - 2021',
                    leftSide: true,
                },
                {
                    educationName: 'E-Complex College ',
                    educationLocation: 'Karachi - College',
                    educationDuration: '2022 - 2024',
                    leftSide: false,
                },
                {
                    educationName: 'Dawood University of Engeineering and technology',
                    educationLocation: 'Karachi - University',
                    educationDuration: '2024 - Present',
                    leftSide: true,
                },
            ],
        },
